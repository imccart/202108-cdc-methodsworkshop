...
insheet using "https://raw.githubusercontent.com/imccart/empirical-methods-extra/main/data/medicaid-expansion/mcaid-expand-data.txt", clear
...
library(data.table)
library(fixest)
mcaid.data <- read_tsv("https://raw.githubusercontent.com/imccart/empirical-methods-extra/main/data/medicaid-expansion/mcaid-expand-data.txt")
...
library(data.table)
library(fixest)
mcaid.data <- read_tsv("https://raw.githubusercontent.com/imccart/empirical-methods-data/main/data/medicaid-expansion/mcaid-expand-data.txt")
reg.dat <- as.data.table(mcaid.data) %>% 
